...
class TwitterClient:
    def __init__(self):
        ...
        self.is_logged_in = True  # Assume logged in since browser opens logged in
    ...
    def _setup_browser(self):
        ...
        # Navigate directly to the home page - FIXED wait_until parameter
        try:
            self.page.goto("https://x.com/home", timeout=60000, wait_until="domcontentloaded")
            logger.info("Navigated to Twitter home page")
        except Exception as e:
            logger.error(f"Error navigating to home page: {str(e)}")
    ...
    def post_tweet(self, content):
        ...
        # No need to check login since we assume browser is already logged in
